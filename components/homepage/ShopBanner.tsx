    ...
    return (
        <div>
            <section className="shop-our-brand flex justify-center mx-auto px-4 sm:px-8">
                <div className="w-full max-w-[1720px] sm:px-8 h-auto bg-[#BBA887] rounded-[9px] lg:rounded-[50px]">

                    <div className="text-white font-[500] text-[18px] md:text-[32px] sm:text-[40px] leading-[48px] sm:leading-[60px] flex justify-center pt-4 xl:pt-[80px] ">
                        Shop Our Brand
                    </div>

                    <div className="grid max-w-[1440px] w-full  sm:mx-auto  gap-[36px] pt-[20px] xl:pt-[40px] place-items-center pb-[80px]  shopbanner-card " style={{ }}>

                        {
                            products && products.map((item: any, index: any) => {
                                return (
                                    <div key={index}>
                                        <div className="w-full min-w-[333px] sm:w-[340px] min-h-[436px] h-auto flex-col  overflow-hidden border-[1px] rounded-[20px] text-white  lg:mx-0">
                                            ...
                                            <div className=" flex flex-col gap-1 pt-[10px] pb-[20px] px-5">
                                                <div className=" text-[16px] sm:text-[18px] w-[300px] truncate ">{item.title}</div>
