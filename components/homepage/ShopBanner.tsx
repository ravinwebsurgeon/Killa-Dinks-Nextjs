                    ...
                    <div className="flex flex-wrap justify-center gap-[36px] pt-[40px] pb-[50px] ">
                        {
                            products && products.map((item: any, index: any) => {
                                return (
                                    <div key={index}>
                                        <div className="w-full sm:w-[340px] h-[430px] flex-col  overflow-hidden border-[1px] rounded-[20px] text-white  mx-[20px] lg:mx-0">
                                            <div className="max-h-[302px]  overflow-hidden group bg-[#FAF7EB] h-full rounded-t-[20px] flex justify-center items-center">
                                            ...
                                            <div className="pl-[18px]">
                                                ...
                                                <Link  href={`/product/${item.handle}`}  className="my-[10px] py-[6px] text-[16px] sm:text-[18px] text-[#BBA887] bg-[#FAF7EB] px-6 rounded-[20px]">
                                                    Choose Options
                                                </Link>
                                            </div>
                                        </div>
