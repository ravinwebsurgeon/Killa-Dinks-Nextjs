            ...
            return (
              <button
                ...
                className={clsx(
                  ...
                  {
                    'cursor-default ring-2 ring-[#bba887]': isActive,
                    'ring-1 ring-transparent transition duration-300 ease-in-out hover:ring-[#bba887]':
                      !isActive && isAvailableForSale,
                    'relative z-10 cursor-not-allowed overflow-hidden text-neutral-500 ring-1 before:absolute before:inset-x-0 before:-z-10 before:h-px before:-rotate-45 before:bg-neutral-300 before:transition-transform dark:bg-neutral-900 dark:text-neutral-400 dark:ring-neutral-700 before:dark:bg-neutral-700':
                      !isAvailableForSale
                  }
                )}
              >
