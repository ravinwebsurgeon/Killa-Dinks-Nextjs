  ...
  return (
    <div>
      <label htmlFor={id} className="">
        <div
          data-v-c419d1c4=""
          className="relative flex h-[calc(100vh-192px)] max-h-screen w-full cursor-pointer flex-col items-center justify-center opacity-70 hover:opacity-100 md:h-[calc(95vh-200px)] md:max-h-[1200px]"
        >
          <svg
          ...
          <div className="font-futura text-2xl font-bold">Upload image</div>
          <div className="font-montaguslab text-base leading-7">
