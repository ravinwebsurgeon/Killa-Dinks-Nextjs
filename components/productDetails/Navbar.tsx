...
const Navbar = () => {
  ...
  return (
    <header className="bigger-navbar z-50  bg-[#FAF7EB] ">
    {/* Mobile Header */}
    ...
    <div className="banner gap-[30px]  mx-2 md:mx-[20px]   xl:mx-[43px]">
      ...
      <div className="bg-black rounded-t-[50px]  left-0 right-0 top-0 hidden py-[13px] lg:left-0 lg:top-[0px] lg:flex">
        <div className="mx-auto flex items-center justify-center gap-[30px] text-white xl:w-full xl:max-w-[1440px] xl:justify-between xl:px-8">
          <div>
            <img
              src={logo.src}
              alt="Logo"
